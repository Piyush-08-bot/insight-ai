...
render(
  React.createElement(App, {
    ...
    flags: {
      ...
      persistDir: flags.persistDir as string | undefined,
      fileTypes: flags.fileTypes as string | undefined,
      embedding: flags.embedding as string | undefined,
      output: flags.output as string | undefined,
      demo: flags.demo as boolean | undefined,
    },
  })
);
